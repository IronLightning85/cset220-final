...
<div class="nav">
    ...
    @endif
                ...
                @if($level == 1)
                    ...
                    <td><button onclick="location.href='{{ url('appointment') }}'">Doctor's Appointment</button></td>
                    ...
                    <td><button onclick="location.href='{{ url('unapproved-users') }}'">Registration Approval</button></td>
